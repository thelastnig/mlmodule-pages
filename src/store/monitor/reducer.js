...
export const LOAD_LIST_REQUEST = 'monitor/LOAD_LIST_REQUEST';
export const LOAD_LIST_SUCCESS = 'monitor/LOAD_LIST_SUCCESS';
export const LOAD_LIST_FAILURE = 'monitor/LOAD_LIST_FAILURE';
export const UPDATE_SORTING = 'monitor/UPDATE_SORTING';
export const INIT_DATA = 'monitor/TEMPLATE_INIT_DATA';
