...
export const LOAD_LIST_REQUEST = 'resoruce/LOAD_LIST_REQUEST';
export const LOAD_LIST_SUCCESS = 'resoruce/LOAD_LIST_SUCCESS';
export const LOAD_LIST_FAILURE = 'resoruce/LOAD_LIST_FAILURE';
export const UPDATE_SORTING = 'resoruce/UPDATE_SORTING';
export const INIT_DATA = 'resoruce/TEMPLATE_INIT_DATA';
