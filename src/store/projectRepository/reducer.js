...
export const LOAD_LIST_REQUEST = 'projectRepository/LOAD_LIST_REQUEST';
export const LOAD_LIST_SUCCESS = 'projectRepository/LOAD_LIST_SUCCESS';
export const LOAD_LIST_FAILURE = 'projectRepository/LOAD_LIST_FAILURE';
export const UPDATE_SORTING = 'projectRepository/UPDATE_SORTING';
export const INIT_DATA = 'projectRepository/TEMPLATE_INIT_DATA';
