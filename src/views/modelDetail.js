...
import VersionTable from 'components/modelRepository/VersionTable';
import PaginationComponent from 'components/common/PaginationComponent';
import { ROUTER_MODEL_REPOSITORY } from 'components/layout/MenuConst';
...
export default function ModelDetail(props) {
	...
	let [maxVersion, change_maxVersion, set_maxVersion] = useInput('');
	...
	const backBtnClicked = () => {
		history.push('/' + ROUTER_MODEL_REPOSITORY);
	};
